...
# Path to the image
image_path = '../FaceRecognitionRealTimeDatabase/Images/42663.png'

# Detect face and crop the image
cropped_face = detect_face(image_path)

if cropped_face is not None:
    # Display the cropped face
    cv2.imshow("Cropped Face", cropped_face)
    output_path = '../FaceRecognitionRealTimeDatabase/Images/42663.png'  # Specify the output path and filename
